...
class pdf_enc:
    ...
    def __init__(self,folder,dbname,recievermailid,sendermailid,sendermailid_passwrd):
        self.sendermailid = sendermailid
        self.sendermailid_passwrd = sendermailid_passwrd
        self.folder=folder
        self.dbname=dbname
    ...
    def mail(self):
        ...
        try:
            ...
            s.login(self.sendermailid, self.sendermailid_passwrd)

            message = "hi shetty your pdf's has got encrpted please do contact us if you have any queries,Thank You"


            s.sendmail(self.sendermailid, self.recievermailid, message)
            print(message)
...
def main():
    ...
    try:
        ...
        sendermailid=input("Enter the mail id from which you want to send mail")
        sendermailid_passwrd=input("Enter the password of mailid through which you want to send")
        mypdf_enc = pdf_enc(sourceloc, dbname, recievermailid,sendermailid,sendermailid_passwrd)
